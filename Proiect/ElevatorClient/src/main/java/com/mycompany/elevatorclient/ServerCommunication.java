...
public class ServerCommunication{
    ...
    public List<String> getBuildingNamesFor(String username) {
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create("http://localhost:2434/accounts/buildingNames/"+username))
                .build();
        try {
            HttpResponse<String> response = client.send(request, BodyHandlers.ofString());
            Gson gson = new Gson();
    ...
    public boolean deleteAccount(String username){
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create("http://localhost:2434/accounts/"+username))
                .DELETE()
                .build();
    ...
    public boolean changeUsername(String oldName, String username){
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create("http://localhost:2434/accounts/"+oldName+"/username"))
                .header("Content-Type", "application/x-www-form-urlencoded")
    ...
    public boolean changePassword(String username, String password){
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create("http://localhost:2434/account/"+username+"/password"))
                .header("Content-Type", "application/x-www-form-urlencoded")
